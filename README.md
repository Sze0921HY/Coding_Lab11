...
When updating obstacles in real real-time there is the chance of the obstacles to trap the AI or accidentally messing up other objects within the environment. 
